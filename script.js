...
const API_KEY = "5d08fb400a5541de4cdfdcf6eeb8dd4d"; // API key for OpenWeatherMap API
    ...
    navigator.geolocation.getCurrentPosition(
        ...
        error => {
            if (error.code === error.PERMISSION_DENIED) {
                ...
                alert("Geolocation request denied. Please allow location permission to access again.");
            }
        }
    );
};
